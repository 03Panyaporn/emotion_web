...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-900 via-black to-zinc-800 text-white p-4 flex justify-center">
      <div className="w-full max-w-5xl space-y-5">
  
        {/* Header */}
        <header className="space-y-1">
          <h1 className="text-3xl font-extrabold tracking-tight text-green-400">
        ...
        {/* Status / Emotion / Confidence */}
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Status */}
          <div className="rounded-2xl p-4 bg-zinc-900/70 border border-zinc-800 shadow-md">
            <div className="text-xs text-zinc-400 flex items-center gap-2">
               Status
            </div>
            <div className="mt-1 text-lg font-semibold text-green-300 truncate">
              {status}
            </div>
          </div>
        ...
        <p className="text-xs text-zinc-500 text-center">
          กดปุ่ม <span className="text-green-400 font-medium">Start Camera</span> เพื่อขอสิทธิ์ใช้งานกล้อง
        </p>
